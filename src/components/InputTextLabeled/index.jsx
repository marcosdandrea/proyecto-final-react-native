...
const InputTextLabeled = ({ label, error, Button, keyboardType="default", onChangeText, props, containerBackgroundColor, value="", style, isPassword=false, autoCapitalize="none" }) => {
