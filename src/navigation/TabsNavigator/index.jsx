  ...
  return (
    <BottomTab.Navigator
      ...
      screenOptions={{
        ...
        tabBarActiveTintColor: colors.foreground.primary,
        tabBarInactiveTintColor: colors.background.primary,
        tabBarIconStyle: {
          fontSize: 22,
        },
      }}
    >
      ...
      <BottomTab.Screen
        ...
        options={{
          tabBarBadge: 45,
          tabBarBadgeStyle: {top: -20, left: 10, backgroundColor: colors.background.primary},
          tabBarLabel: "",
          tabBarIcon: ({ focused }) => (
            <MainButtonTab focused={focused} size={70} tabBarColor={colors.background.secondary}/>
          ),
        }}
